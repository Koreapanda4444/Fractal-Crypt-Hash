...
static const regression_baseline_t BASELINES[] = {
    { 63,   FLIP_SWEEP, 50.56, 18.75, 50.05, 10.16 },
    { 64,   FLIP_SWEEP, 49.98, 15.23, 49.91, 10.94 },
    { 65,   FLIP_SWEEP, 49.76, 17.19, 49.94, 10.74 },
    { 127,  FLIP_SWEEP, 49.91, 16.80, 49.97, 11.72 },
    { 128,  FLIP_SWEEP, 49.89, 17.58, 49.57, 11.52 },
    { 129,  FLIP_SWEEP, 49.77, 20.70, 50.25, 11.33 },
    { 255,  FLIP_SWEEP, 50.00, 14.06, 50.18, 9.96 },
    { 257,  FLIP_SWEEP, 49.58, 14.06, 50.14, 12.70 },
    { 512,  FLIP_SWEEP, 50.23, 16.41, 50.06, 10.35 },
    { 1024, FLIP_SWEEP, 50.01, 15.62, 50.00, 12.30 },
    { 4096, FLIP_SWEEP, 50.52, 18.75, 50.03, 12.11 },
};
